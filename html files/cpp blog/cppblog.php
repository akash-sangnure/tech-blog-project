...
<html>
    ...
    <body >
        ...
        <div class="grid-container">
            ...
            <div style="text-align: center;"><br><strong><h3>Why to Learn C++</h3></strong><br></div>  
            <ul>
                <li>C++ is a MUST for students and working professionals to become a great Software Engineer. I will list down some of the key advantages of learning C++:</li>
                ...
                <li>C++ programming gives you a clear understanding about Object Oriented Programming. You will understand low level implementation of polymorphism when you will implement virtual tables and virtual table pointers, or dynamic type identification.</li>
            ...
            <div style="text-align: center;"><br><strong><h3>C++ Compilers:</h3></strong><br></div>
            <ul>
                <li>Apple C++. Xcode</li>
            ...
            <ul>
                <li><strong>Application Software Development</strong> - C++ programming has been used in developing almost all the major Operating Systems like Windows, Mac OSX and Linux. Apart from the operating systems, the core part of many browsers like Mozilla Firefox and Chrome have been written using C++. C++ also has been used in developing the most popular database system called MySQL.</li>
                <li><strong>Programming Languages Development</strong>  - C++ has been used extensively in developing new programming languages like C#, Java, JavaScript, Perl, UNIX’s C Shell, PHP and Python, and Verilog etc.
                <li><strong>Computation Programming</strong>  - C++ is the best friends of scientists because of fast speed and computational efficiencies.
                <li><strong>Games Development</strong>  - C++ is extremely fast which allows programmers to do procedural programming for CPU intensive functions and provides greater control over hardware, because of which it has been widely used in development of gaming engines.
                <li><strong>Embedded System</strong>  - C++ is being heavily used in developing Medical and Engineering Applications like softwares for MRI machines, high-end CAD/CAM systems etc.
            </ul>
